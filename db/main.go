...
const bucketName string = "seven-store-bucket"
...
func Save(db *bolt.DB, key, value string) error {
	// Save data
...
func GetAll(db *bolt.DB) map[string]string {
...
func GetAllWitPrefix(db *bolt.DB, prefix string) map[string]string {
	records := map[string]string{}
